...
export default function Contact() {
  ...
  return (
    <div className="relative min-h-[100dvh] overflow-hidden flex items-center justify-center bg-white px-4 sm:px-6 py-16 pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]">
      <div
        className="absolute inset-0 bg-zinc-100 hidden md:block"
        style={{ clipPath: "polygon(0 0, 52% 0, 36% 100%, 0 100%)" }}
      />
      <div
        className="absolute inset-0 bg-zinc-100 block md:hidden"
        style={{ clipPath: "polygon(0 0, 74% 0, 12% 100%, 0 100%)" }}
      />

      <div className="relative z-10 w-full max-w-4xl flex flex-col md:flex-row gap-12 items-start">
        ...
        <div className="w-full md:w-3/5">
          <div className="mb-8">
            ...
            <p className="mt-3 text-base text-neutral-600">
              Let's talk about your project, idea, or next opportunity.
            </p>
          </div>
        ...
        <div className="w-full md:w-2/5 flex flex-col gap-6 md:pt-16">
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              <div className="w-9 h-9 rounded-lg bg-white border border-neutral-200 flex items-center justify-center group-hover:border-neutral-300 transition-colors">
                <svg className="w-4 h-4" viewBox="0 0 24 24" aria-hidden="true">
                  <path fill="#4285F4" d="M3 6.5v11h3v-6.9L3 8.5Z" />
                  <path fill="#EA4335" d="M3 6.5h3l6 4.4 6-4.4h3L12 13Z" />
                  <path fill="#FBBC05" d="m12 13 2 1.5L21 8.5v-2Z" />
                  <path fill="#34A853" d="M18 10.3v7.2h3v-11Z" />
                </svg>
              </div>
              <div>
            ...
            <a
              ...
              className="flex items-center gap-3 p-4 rounded-xl border border-neutral-200 hover:border-neutral-400 transition-colors group"
            >
              <div className="w-9 h-9 rounded-lg bg-blue-500 flex items-center justify-center group-hover:bg-blue-600 transition-colors">
            ...
            <a
              ...
              className="flex items-center gap-3 p-4 rounded-xl border border-neutral-200 hover:border-neutral-400 transition-colors group"
            >
              <div className="w-9 h-9 rounded-lg bg-[#25D366] flex items-center justify-center group-hover:bg-[#1ebe5d] transition-colors">
